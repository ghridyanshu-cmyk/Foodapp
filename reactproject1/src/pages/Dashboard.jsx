    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
            <div className="w-full max-w-lg space-y-6">
                ...
                <h1 className="text-3xl font-extrabold text-center text-gray-800 flex items-center justify-center space-x-2">
                ...
                <div 
                    ...
                    className="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition cursor-pointer flex items-center justify-between"
                >
                    <div className="flex items-center space-x-4">
                        <div className={`p-3 rounded-full bg-emerald-100 ${PRIMARY_COLOR}`}>
                            <User className="w-6 h-6" />
                        </div>
                        <div>
                            <h2 className="text-lg font-semibold text-gray-700">User Dashboard</h2>
                            <p className="text-sm text-gray-500">Access profile, orders, and shopping.</p>
                        </div>
                    </div>
                ...
                >
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-gray-700">Owner Access Panel</h2>
                            <p className="text-sm text-gray-500">Manage videos, inventory, and analytics.</p>
                        </div>
                    </div>
