...
// 🚨 IMPORTANT: Ensure you include the Razorpay SDK script in your index.html/root file:
...
const Payment = () => {
  ...
  useEffect(() => {
    ...
    return (
      <div className="flex min-h-screen bg-gradient-to-r from-gray-200 to-green-500 items-center justify-center font-inter">
        <div className="flex flex-col md:flex-row gap-8 w-full max-w-4xl p-4">
          {/* Payment Options Card (Left) */}
          <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-sm mx-auto">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-col gap-2">
                {paymentOptions.map(opt => (
                  <label key={opt.label} className={`flex items-center gap-3 px-3 py-3 rounded-xl cursor-pointer transition-all ${selectedOption === opt.label ? 'bg-emerald-50 border border-emerald-400 shadow-sm' : 'bg-gray-100'}`}
